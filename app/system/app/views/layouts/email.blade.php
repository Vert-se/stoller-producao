                                    ...
                                    <table border="0" cellpadding="0" cellspacing="0" width="600" id="templateHeader">
                                        <tr>
                                            <td class="headerContent">
                                                ...
                                                <img src="{{ asset('images/header-email.png') }}" style="max-width:600px;" id="headerImage campaign-icon" mc:label="header_image" mc:edit="header_image" mc:allowdesigner mc:allowtext />
                                                    ...
                                                    <tr>
                                                        <td valign="top">
                                                            <div mc:edit="std_footer">
                                                                <em>Copyright &copy; 2015 Stoller, Todos os direitos reservados.</em>
                                                            </div>
                                                        </td>
                                                    </tr>
                                                </table>
